...
class DotComponent extends HTMLElement {
    constructor() {
        ...
        this.$template = (context) => html `<!-- Empty component -->`;
    ...
    render() {
        if (!this.shadowRoot)
            throw Error('Before render, shadowroot must be mounted');
    ...
    get handler() {
        ...
        return {
            ...
            set(target, key, value, receiver) {
                const old = context._data[key];
                const r = Reflect.set(target, key, value, receiver);
                if (context.$watchers.get(key)) {
                    context.$watchers.get(key).call(context, context._data[key], old);
                }
                context.render();
                return r;
            }
    ...
    get refs() {
        ...
        return {
            get(target, key, receiver) {
                var _a;
                return (_a = context.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector(`[ref="${key}"]`);
            },
            set() {
    ...
    get $children() {
        var _a;
        return new Array((_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelectorAll('[dot]'));
    }
}

class DotRouterLink extends DotComponent {
    static get tag() { return 'router-link'; }
    constructor() {
        super();
        this.$template = () => html `
...
class DotRouterView extends DotComponent {
    static get tag() { return 'router-view'; }
    constructor() {
        super();
        this.$template = () => html ``;
    }
...
const register = (descriptor) => {
    ...
    customElements.define(descriptor.tag, descriptor);
};
...
class DotRouter {
    ...
    init(app) {
        ...
        window.addEventListener('dot-router-navigate', (event) => this.linkNavigate(event));
        this.navigate(this.location);
    }
    navigate(path, foreward = true) {
        var _a, _b, _c, _d, _e;
        return __awaiter(this, void 0, void 0, function* () {
            if (this.$mode === 'out-in') {
                yield ((_a = this.$route) === null || _a === void 0 ? void 0 : _a.leave());
                (_b = this.$route) === null || _b === void 0 ? void 0 : _b.remove();
                if (foreward)
                    window.history.pushState({}, '', path);
                this.matchRoute(path);
                if (this.$route)
                    (_c = this.$view.shadowRoot) === null || _c === void 0 ? void 0 : _c.appendChild(this.$route);
                this.$view.render();
                requestAnimationFrame(() => { var _a; return (_a = this.$route) === null || _a === void 0 ? void 0 : _a.enter(); });
            }
                ...
                this.matchRoute(path);
                if (this.$route)
                    (_d = this.$view.shadowRoot) === null || _d === void 0 ? void 0 : _d.appendChild(this.$route);
                this.$view.render();
                yield ((_e = this.$route) === null || _e === void 0 ? void 0 : _e.enter());
                yield (current === null || current === void 0 ? void 0 : current.leave());
...
class DotApp {
    ...
    mount(component, parent) {
        ...
        else if (((_a = component.$parent) === null || _a === void 0 ? void 0 : _a.shadowRoot) && this.$container) {
    ...
    get $children() {
        var _a;
        return new Array((_a = this.$container) === null || _a === void 0 ? void 0 : _a.querySelectorAll('[dot]'));
    }
}
...
export { DotApp, DotComponent, DotRoute, DotRouter, html, register };
